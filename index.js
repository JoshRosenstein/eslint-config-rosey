module.exports = {
  ...
  rules: {
    ...
    // quotes: 0, // prettier [1, 'single', 'avoid-escape'], // specify whether double or single quotes should be used
    // 'quote-props': 0, // require quotes around object literal property names (off by default)
    // semi: 0, //1 - prettier // require or disallow use of semicolons instead of ASI
    // 'sort-vars': 0, // sort variables within the same declaration block (off by default)
    // 'space-in-brackets': 0, // require or disallow spaces inside brackets (off by default)
    // 'space-in-parens': 0, // require or disallow spaces inside parentheses (off by default)
    // 'space-infix-ops': 0, //1, prettier // require spaces around operators
    // 'space-unary-ops':0, // pret [1, { words: true, nonwords: false }], // require or disallow spaces before/after unary operators (words on by default, nonwords off by default)
